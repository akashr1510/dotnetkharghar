...
namespace ClientForWebApi
{
    class Program
    {
        ...
        static string url = "http://localhost:49217/api/";
        //post
        static void Main1()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var empstr = "{\"EmpNo\": 10000,\"Name\": \"Harsh\",\"Basic\": 22345,\"DeptNo\": 20}";
        ...
        static void Main4()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var empstr = "{\"EmpNo\": 10000,\"Name\": \"Changed Value\",\"Basic\": 22345,\"DeptNo\": 20}";
                HttpContent content = new StringContent(empstr, Encoding.UTF8, "application/json");

                var responseTask = client.PutAsync("Employees/10000", content);
                responseTask.Wait();
        ...
        static void Main()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var responseTask = client.DeleteAsync("Employees/10000");
                responseTask.Wait();
